    ...
    recalcAllPrice();
      ...
      '<li class="calc-item calc-pr-item" id="item'+randomID+'">'+
        ...
        '<div class="calc-item-content">'+
          ...
          '</div>'+
          '<div class="c-item-price c-pr-item-price"><span>'+priceLotStr+'</span><i class="rub">В</i></div>'+
...
$('.btn-filter').on('click', function(e) {
  ...
  if(windowWidth <= 767) {
    ...
    if($(this).hasClass('active')) {
      ...
      $('.filter__box').removeClass('activeBox').slideUp(0);
...
$('.btn-clear').on('click', function(e) {
  ...
  if(windowWidth >= 768) {
    ...
    if($('.f-btn-sort').hasClass('active')) {
      ...
      $('.filter__box, .filter__bottom, .filter__clear').fadeOut();
      $('.filter__clear').removeClass('active');
    }
